...
public interface BookRepository extends JpaRepository<BookEntity, Long> {
	...
	@Query("select book from BookEntity book where book.id = :bookId")
	public BookEntity findBookById(@Param("bookId") Long id);
	...
	public List<BookEntity> findBooksByAuthorAndTitle(@Param("author") String author, @Param("title") String title);
}
